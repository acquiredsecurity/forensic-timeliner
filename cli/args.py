...
def parse_arguments():
    ...
    parser.add_argument('--FileDeletionSubDir', default='None')
    parser.add_argument('--RegistrySubDir', default='None')
    parser.add_argument('--ProgramExecSubDir', default='None')
    parser.add_argument('--FileFolderSubDir', default='None')
    parser.add_argument('--FileSystemSubDir', default='None')
    parser.add_argument('--EventLogsSubDir', default='None')
    parser.add_argument('--NirsoftSubDir', default='None')
