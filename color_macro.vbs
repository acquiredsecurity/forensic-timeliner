Sub ColorRowsByArtifactName_Simple()
    ...
    If Not colorMap.Exists("FirefoxHistory") Then colorMap.Add "FirefoxHistory", RGB(112, 128, 144) ' Slate Gray
    ...
    If Not colorMap.Exists("OperaHistory") Then colorMap.Add "OperaHistory", RGB(147, 112, 219) ' Medium Purple
    If Not colorMap.Exists("PrefetchFiles") Then colorMap.Add "PrefetchFiles", RGB(255, 140, 0) ' Dark Orange
    If Not colorMap.Exists("Registry") Then colorMap.Add "Registry", RGB(255, 215, 0) ' Gold
    If Not colorMap.Exists("Registry - AutoRun Items") Then colorMap.Add "Registry - AutoRun Items", RGB(139, 0, 0) ' Dark Red
    If Not colorMap.Exists("Registry - MRU Folder Access") Then colorMap.Add "Registry - MRU Folder Access", RGB(46, 139, 87) ' Sea Green
    ...
    If Not colorMap.Exists("Hayabusa") Then colorMap.Add "Hayabusa", RGB(99, 100, 0)  ' Dark Green 
    ...
    If Not fontColorMap.Exists("FirefoxHistory") Then fontColorMap.Add "FirefoxHistory", RGB(0, 0, 0) ' Black
    ...
    If Not fontColorMap.Exists("mft") Then fontColorMap.Add "mft", RGB(255, 255, 255) ' White
     If Not fontColorMap.Exists("OperaHistory") Then fontColorMap.Add "OperaHistory", RGB(255, 255, 255) ' White
