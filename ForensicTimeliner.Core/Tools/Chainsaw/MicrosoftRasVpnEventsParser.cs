...
public class MicrosoftRasVpnEventsParser : IArtifactParser
{
            ...
            try
            {
                ...
                foreach (var record in records)
                {
                    ...
                    rows.Add(new TimelineRow
                    {
                        ...
                        Tool = artifact.Tool,
                        Description = "RAS VPN Events",
                        DataDetails = dict.GetString("detections"),
                        DataPath = dict.GetString("Remote IP"),
                        DestinationAddress = dict.GetString("Remote IP"),
