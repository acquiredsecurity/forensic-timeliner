...
public class AmcacheParser : IArtifactParser
{
        ...
        foreach (var file in files)
        {
            ...
            try
            {
                ...
                foreach (var record in records)
                {
                    ...
                    var parsedDt = dict.GetDateTime("FileKeyLastWriteTimestamp");
                    ...
                    rows.Add(new TimelineRow
                    {
                        ...
                        DataPath = dict.GetString("FullPath"),
                        DataDetails = dict.GetString("ApplicationName"),
                        FileSize = dict.GetLong("Size"),
                        FileExtension = dict.GetString("FileExtension"),
