...
public class AxiomAmcacheParser : IArtifactParser
{
        ...
        foreach (var file in files)
        {
            ...
            try
            {
                ...
                foreach (var record in records)
                {
                    ...
                    var parsedDt = dict.GetDateTime("Key Last Updated Date/Time - UTC+00:00 (M/d/yyyy)");
                    ...
                    rows.Add(new TimelineRow
                    {
                        ...
                        DataPath = dict.GetString("Full Path"),
                        DataDetails = dict.GetString("Associated Application Name"),
                        FileExtension = dict.GetString("File Extension"),
                        SHA1 = dict.GetString("SHA1 Hash"),
                ...
                LoggerSummary.TrackSummary("Axiom", artifact.Artifact, timelineCount);
            }
            catch (Exception ex)
            {
