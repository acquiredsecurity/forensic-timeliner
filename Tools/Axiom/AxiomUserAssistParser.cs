...
public class AxiomUserAssistParser : IArtifactParser
{
        ...
        foreach (var file in files)
        {
            ...
            try
            {
                ...
                foreach (var record in records)
                {
                    ...
                    var parsedDt = dict.GetDateTime("Last Run Date/Time - UTC+00:00 (M/d/yyyy)");
                    if (parsedDt == null) continue;

                    string dtStr = parsedDt.Value.ToString("o").Replace("+00:00", "Z");


                    var path = dict.GetString("File Name");
                    ...
                    rows.Add(new TimelineRow
                    {
                        ...
                        DataPath = path,
                        DataDetails = dict.GetString("User Name"),
