...
public class LateralMovementParser : IArtifactParser
{
        ...
        foreach (var file in files)
        {
            ...
            try
            {
                ...
                foreach (var record in records)
                {
                    ...
                    var parsedDt = dict.GetDateTime("timestamp") ?? dict.GetDateTime("TimeCreated") ?? dict.GetDateTime("UtcTime");
                    ...
                    rows.Add(new TimelineRow
                    {
                        ...
                        DataPath = dict.GetString("Logon Type"),
                        EventId = dict.GetString("Event ID"),
                        User = dict.GetString("User"),
                        Computer = dict.GetString("Computer"),
                        IPAddress = dict.GetString("IP Address"),
                        DestinationAddress = dict.GetString("Dest Address"),
                        SourceAddress = dict.GetString("Source Address"),
