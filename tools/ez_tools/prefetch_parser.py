...
def process_prefetch(base_dir: str, batch_size: int):
    artifact_name = "Prefetch"
    print(f"[Prefetch] Scanning for relevant CSVs under: {base_dir}")

    prefetch_files = find_artifact_files(base_dir, artifact_name)
