...
def process_chainsaw_applocker(chainsaw_dir: str, batch_size: int, base_dir: str):
    artifact_name = "applocker"
    ...
    for file_path in csv_files:
        ...
        try:
            ...
            "Tool": "Chainsaw",
            "Description": "Applocker Violation",
            "DataDetails": row.get("detections", ""),
            "DataPath": row.get("Scheduled Task Name", ""),
