...
def process_chainsaw_service_installation(chainsaw_dir: str, batch_size: int, base_dir: str):
    artifact_name = "service_installation"
    ...
    for file_path in csv_files:
        ...
        try:
            ...
            "DataPath": row.get("Service Name", ""),
            "EventId": row.get("Event ID", ""),
            "ServiceType": row.get("Service Type", ""),
            "User": row.get("Service Account", ""),
