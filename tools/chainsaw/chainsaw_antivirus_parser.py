...
def process_chainsaw_antivirus(chainsaw_dir: str, batch_size: int, base_dir: str):
    artifact_name = "Chainsaw_Antivirus"
...
def _normalize_rows(df, evidence_path, base_dir):
    ...
    for _, row in df.iterrows():
        ...
        timeline_row = {
            ...
            "Tool": "Chainsaw",
            "Description": "Antivirus - " + str(row.get("detections", "")),
            "DataDetails": row.get("Threat Name", ""),
            "DataPath": row.get("Threat Path", ""),
