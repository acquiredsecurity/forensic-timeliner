...
def process_chainsaw_log_tampering(chainsaw_dir: str, batch_size: int, base_dir: str):
    artifact_name = "Chainsaw_Log_Tampering"
    ...
    for file_path in csv_files:
        ...
        try:
            ...
            "Tool": "Chainsaw",
            "Description": "Log Tampering",
            "DataDetails": row.get("detections", ""),
            "DataPath": "security_log_cleared and not empty",
